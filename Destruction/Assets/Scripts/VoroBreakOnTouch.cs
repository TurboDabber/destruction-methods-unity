...
public class VoroBreakOnTouch : MonoBehaviour
{
    ...
    public bool standardColor = false;
    ...
    void Start()
    {
        ...
        string arguments = $"{bounds.x} {bounds.y} {bounds.z} {numberOfParticles}";
        Stopwatch stopwatch = Stopwatch.StartNew();
        ExecuteRandomCells(programPath, arguments);
        stopwatch.Stop();
        Debug.Log("C++ script set up: " + stopwatch.ElapsedMilliseconds);
        stopwatch.Restart();
        ...
        stopwatch.Stop();
        Debug.Log("Processing C++ script in C#: " + stopwatch.ElapsedMilliseconds);
